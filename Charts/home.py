...
class mainplot:
    ...
    def prepare(self):
        ...
        self.events['start_date'] = self.events['start_date'].apply(lambda x:datetime.strptime(x, "%Y-%m-%d"))
        ...
        self.holograms['start_date'] = self.holograms['start_date'].apply(lambda x:datetime.strptime(x, "%Y-%m-%d"))
        ...
        self.plot_events = figure(plot_width=748, plot_height=525, tools = 'wheel_zoom,box_zoom,reset,save',
                                  ...
                                  title = "How are your your users communicating with app events?")
        ...
        self.plot_holograms = figure(plot_width=748, plot_height=525, tools = 'wheel_zoom,box_zoom,reset,save',
                                     title = "What are the Top AR Holograms people are interacting with?")
    ...
    def update(self):
        ...
        df3_new['color'] = Spectral[df3_new.shape[0]]
        #print(df3_new)
        ...
        self.plot_holograms.xaxis.major_label_overrides = {1: list(df3_new.hologram_loaded)[0], 2: list(df3_new.hologram_loaded)[1],
                                                           3: list(df3_new.hologram_loaded)[2], 4: list(df3_new.hologram_loaded)[3],
                                                           5: list(df3_new.hologram_loaded)[4], 6: list(df3_new.hologram_loaded)[5],
                                                           7: list(df3_new.hologram_loaded)[6], 8: list(df3_new.hologram_loaded)[7],
                                                           9: list(df3_new.hologram_loaded)[8], 10: list(df3_new.hologram_loaded)[9]}
        self.plot_holograms.xaxis[0].ticker.desired_num_ticks = 10
